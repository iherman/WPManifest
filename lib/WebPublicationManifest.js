...
class PublicationLink {
     ...
     */
    constructor(logger, obj, base, lang, m_separate) {
        if (obj instanceof Object) {
     ...
     */
    static initArray(logger, values, base, lang, m_separate) {
        const linkArray = Array.isArray(values) ? values : [values];
        return linkArray.map((name) => new PublicationLink(logger, name, base, lang, m_separate)).filter((link) => link.__invalid !== true);
    }
}
...
class WebPublicationManifest {
     ...
     */
    constructor(logger, base, lang, m_separate) {
        ...
        this._name = undefined;
        this._readingOrder = [new PublicationLink(base, base, lang, false)];
        this._resources = [];
        this._links = [];
        this._toc = undefined;
     ...
     */
    set inker(value) {
        this._inker = Person.initArray(this.__logger, value, this.__base, this.__lang);
    }
    ...
    set readingOrder(value) {
        this._readingOrder = PublicationLink.initArray(this.__logger, value, this.__base, this.__lang, this.__m_separate);
    }
     ...
     */
    set resources(value) {
        this._resources = PublicationLink.initArray(this.__logger, value, this.__base, this.__lang, this.__m_separate);
    }
     ...
     */
    set links(value) {
        this._links = PublicationLink.initArray(this.__logger, value, this.__base, this.__lang, this.__m_separate);
    }
