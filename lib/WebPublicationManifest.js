...
class WebPublicationManifest {
     ...
     *
     * @static
     * @param {LinkedResource[]} where - the array where to locate a link
     * @param {string} rel_value - the relevant rel value
     * @returns {LinkedResource} returns 'undefined' if not found
     */
    ...
    /**
     *
     * <code>LinkedResource  accessibilityReport;</code>
     *
     * @returns {LinkedResource}
     */
    ...
    /**
     *
     * <code>LinkedResource  privacyPolicy;</code>
     *
     * @returns {LinkedResource}
     */
    get privacyPolicy() {
    ...
    // ****************************
    // --- LinkedResource cover;
    /**
     *
     * <code><sequence>LinkedResource  cover;</code>
     *
     * @returns {LinkedResource[]}
     */
    get cover() {
    ...
    async set_toc(dom) {
        ...
        // Locate a toc reference LinkedResource, if any. If it exists, its url member
