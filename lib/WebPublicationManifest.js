...
class LocalizableString {
    ...
    constructor(logger, obj, lang = '') {
        ...
        if (obj instanceof Object) {
            if (logger.error(obj['@value'] !== undefined, 'String without value')) {
...
class WebPublicationManifest {
    ...
    // ****************************
    /**
     * URL of the publication. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * Type of the publication. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * accessModeSufficient. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * accessibilityControl. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * accessibilityAPI. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * accessibilityFeature. Equivalent WebIDL:
     *
    ...
    /**
     * accessibilityHazard. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * accessibilitySummary. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * Base language of the publication. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * Base direction of the publication. Equivalent WebIDL:
     *
    ...
    set inDirection(value) {
        switch (value) {
            ...
            case 'auto':
                ...
                break;
            default:
                this.__logger.warning(false, `"${value}" is not a valid text direction tag`);
        }
    }
    ...
    /**
     * Modification date of the publication. Equivalent WebIDL:
     *
    ...
    set dateModifed(date) {
        if (this.__logger.warning(moment(date).isValid(), `"${date}" is an invalid Date or DateTime string.`)) {
    ...
    // ****************************
    /**
     * Publication date of the publication. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * Progression direction of the publication. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * Reading order of the publication. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * Resources of the publication. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * (External) links of the publication. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * name of the publication. Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * Get the accessibility report (this attribute has no setter). Equivalent WebIDL:
     *
    ...
    // ****************************
    /**
     * Get the privacy policy (this attribute has no setter). Equivalent WebIDL:
     *
    ...
    /**
     * Get the cover (this attribute has no setter). Equivalent WebIDL:
     *
