...
async function obtain_manifest(dom) {
    try {
        ...
        if (ref[0] === '#') {
            ...
            manifestObject = await process_manifest(fetch_html, manifest_text, dom, script.baseURI,
            ...
            manifestObject = await process_manifest(fetch_html, manifest_text, dom, link.href);
        }
