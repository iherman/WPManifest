 ...
 * @return {Promise} - encapsulating the body of the resource. If the content_type is JSON,
 *    this is a JS object; if it is HTML, it is a DOM tree
 */
 ...
 */
exports.fetch_html = async (html_url) => {
    try {
...
/*
 * Fetch an JSON file. Note that it is not symmetric not to return the parsed JSON value
 ...
 */
exports.fetch_json = async (json_url) => {
    try {
