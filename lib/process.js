...
function get_canonical_manifest(logger, manifest_data) {
    ...
    try {
        ...
        logger.assert(false, `(In processing the manifest) ${err.message}`, LogLevel.error);
