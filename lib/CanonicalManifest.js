...
const properties_with_objects = [...creator_properties, ...resource_categorization_properties];
const array_properties = [...misc_arrays_properties, ...a11y_properties, ...properties_with_objects];
 ...
 */
function canonicalize(logger, manifest_orig, base, document = undefined, lang = '', dir = '') {
    let manifest = {};
    let language = '';
    ...
    try {
        ...
        logger.assert(true, err.message, LogLevel.error);
        console.log(err);
    }
}
